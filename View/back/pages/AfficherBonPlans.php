...
<body class="g-sidenav-show bg-gray-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Gestion Bon Plans</li>
  ...
  <div class="input-group input-group-outline">
    ...
    <input type="text" class="form-control" name="search_destination">
  </div>
</form>
        ...
        <div class="col-12">
          ...
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              <h6 class="mb-0">Liste des BonPlans</h6>
              <div>
                <a href="AfficherReservations.php" class="btn btn-custom btn-sm">Liste Reservations</a>
                <a class="btn btn-custom btn-sm" href="AjouterBonPlan.php">Nouvelle BonPlan</a>
                <a href="ExporterBonPlan.php" class="btn btn-outline-secondary btn-sm ms-2">Exporter</a>
