...
if (isset($_GET['search_destination']) && !empty($_GET['search_destination'])) {
  $listBonPlans = $BonPlanC->RechercherBonPlanParDestination($_GET['search_destination']);
} else {
...
<head>
  ...
  <style>
    ...
    .btn-export-excel, .btn-export-pdf, .btn-export-csv {
      border: none;
      border-radius: 8px;
      padding: 0.8rem;
      width: 100%;
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Bon Plans</li>
        </ol>
      </nav>
    </div>
  </nav>
  ...
  <div class="container-fluid py-2">
    ...
    <div class="row mb-4">
      <div class="col-12">
        <h3 class="mb-0 h4 font-weight-bolder">Gestion des Bon Plans</h3>
        <p class="mb-0">Traiter et suivre les bon plans des clients.</p>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-body p-3">
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  <p class="text-sm mb-0 text-capitalize font-weight-bold">BonPlans totales</p>
    ...
    <!-- Listing des Bon Plans -->
    <div class="row">
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0 d-flex justify-content-between align-items-center">
            <h6 class="mb-0">Liste des Bon Plans</h6>
            <div>
              <a href="AfficherReservations.php" class="btn btn-custom btn-sm">Liste Reservations</a>
              <a class="btn btn-custom btn-sm" href="AjouterBonPlan.php">Nouveau Bon Plan</a>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">RESTAURANT</th>
                ...
                <tbody>
                  <?php foreach ($listBonPlans as $bonplan): ?>
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $bonplan['idBonplan']; ?></p>
                      </td>
                      <td>
                        <h6 class="mb-0 text-sm"><?php echo $bonplan['destination']; ?></h6>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $bonplan['restaurant']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?php echo $bonplan['hotel']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?php echo $bonplan['dateCreation']; ?></p>
                      </td>
                      <td class="align-middle text-center">
                        <form method="GET" action="AjouterReservation.php">
                          <input type="hidden" value="<?php echo $bonplan['idBonplan']; ?>" name="idBonplan">
                        </form>
                        <form method="GET" action="ModifierBonPlan.php">
                          <input type="submit" class="btn btn-custom btn-sm" name="Modifier" value="Modifier">
                          <input type="hidden" value="<?php echo $bonplan['idBonplan']; ?>" name="idBonplan">
                        </form>
                        <a href="SupprimerBonPlan.php?idBonplan=<?php echo $bonplan['idBonplan']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
      ...
      <div class="modal-content" style="border-radius: 12px;">
        <div class="modal-header bg-gradient-primary py-3" style="background: linear-gradient(195deg, #0ABAB5, #00897B);">
          <h5 class="modal-title text-white fs-6 mb-0">
            <i class="fas fa-file-export me-2"></i>Exporter les Bon Plans
          </h5>
...
function exportData(format) {
  ...
  form.method = 'GET';
  form.action = 'ExporterBonPlan.php';
