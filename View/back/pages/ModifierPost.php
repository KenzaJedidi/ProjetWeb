...
if (isset($_POST["title"]) && isset($_POST["content"]) && isset($_FILES["image"])) {
  if (!empty($_POST["title"]) && !empty($_POST["content"]) && !empty($_FILES["image"])) {
    ...
    $Post = new Post(1,$_POST['title'], $_POST['content'], $filename);
...
<body class="g-sidenav-show bg-gray-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="AfficherPosts.php">Forum</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Modifier un post</li>
          </ol>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Ajouter un Post</h6>
              </div>
            </div>
              ...
              <form method="POST" enctype="multipart/form-data" >
                ...
                <div class="row">
                  ...
                  <label class="form-label">Contenu</label>
                    <div class="input-group input-group-outline mb-4">
                      <input type="text" class="form-control" name="content" id="content" value="<?php echo $Post['content']; ?>">
                    </div>
                  ...
                  <label class="form-label">Image</label>
                    <div class="input-group input-group-outline mb-4">
                      <input type="file" class="form-control" name="image" id="image" value="<?php echo $Post['image']; ?>">
                ...
                <div class="row">
                  <div class="col-md-12 text-end">
                    <a href="AfficherPosts.php" class="btn btn-outline-secondary">Annuler</a>
  ...
  <script src="../../front/assets/js/Controle.js"></script>
</body>
