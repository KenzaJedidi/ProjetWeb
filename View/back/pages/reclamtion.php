              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $reclamation['idReclamation']; ?></p>
                      </td>
                      <td>
                      <h6 class="mb-0 text-sm">
                        <?php
                          $user = $UserC->RecupererUser($reclamation['idUser']);
                          echo $user['username'];
                        ?>
                    </h6>
                      </td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $reclamation['Message']; ?></p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?php echo $reclamation['dateReclamation']; ?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        ...
                        if ($statut === 'En Cours') {
                            ...
                            $badgeClass = 'badge badge-resolved';
                        }
                      ?>
                      ...
                      <td class="align-middle text-center">
                        <form method="GET" action="AjouterReponse.php">
                          <input type="submit" class="btn btn-custom btn-sm" name="Repondre" value="Repondre">
                          <input type="hidden" value=<?php echo $reclamation['idReclamation']; ?> name="idReclamation">
                        </form>
                        <a href="SupprimerReclamation.php?idReclamation=<?php echo $reclamation['idReclamation']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                      </td>
                    </tr>
