...
$PostC = new PostC();
$userC = new UserC();
$listCommentaires = $CommentC->AfficherComments();
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Gestion Commentaires</li>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline">
              <label class="form-label">Rechercher un commentaire...</label>
    ...
    <div class="container-fluid py-2">
      ...
      <div class="row mb-4">
        <div class="col-12">
          <h3 class="mb-0 h4 font-weight-bolder">Gestion des Commentaires</h3>
          
          <p class="mb-0">Traiter et suivre les commentaires des clients.</p>
        </div>
      </div>
        ...
        <div class="col-12">
          ...
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              <h6 class="mb-0">Liste des Posts</h6>
              <div>
              <a class="btn btn-custom btn-sm" href="AfficherPosts.php">Liste Posts</a>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $commentaire['id']; ?></p>
                      </td>
                      <td>
                      <h6 class="mb-0 text-sm">
                      <?php 
                        $user = $userC->RecupererUser($commentaire['user_id']);
                        echo $user['username']; ?>
                    </h6>
                      </td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">
                          <?php  
                          $postC = new PostC();
                          $post = $postC->RecupererPost($commentaire['post_id']);
                          echo $post['title']; ?>
                        </p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?php echo $commentaire['content']; ?></p>
                      </td>

                      <td>
                        <p class="text-xs mb-0"><?php echo $commentaire['created_at']; ?></p>
                      </td>

                      <td class="align-middle text-center">
                        <form method="GET" action="ModifierCommentaire.php">
                        ...
                        <a href="SupprimerCommentaire.php?id=<?php echo $commentaire['id']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                      </td>
                    </tr>
