...
if (isset($_POST["destination"]) && isset($_POST["restaurant"]) && isset($_POST["hotel"])) {
  if (!empty($_POST["destination"]) && !empty($_POST["restaurant"]) && !empty($_POST["hotel"])) {
    ...
    $BonPlanC->AjouterBonPlan($BonPlan);
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajouter un Bon Plan</li>
          </ol>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Ajouter un Bon Plan</h6>
              </div>
            </div>
            <div class="card-body px-4 pb-2">
              <!-- Form to add a Bon Plan -->
              <form method="POST" action="" onkeyup="return validateForm();">
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-sm text-muted text-lg-start">
              ...
              </script> Localoo. Tous droits réservés.
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              ...
              <li class="nav-item">
                <a href="https://www.localoo.com/about-us" class="nav-link text-muted" target="_blank">À propos</a>
              </li>
              <li class="nav-item">
                <a href="https://www.localoo.com/blog" class="nav-link text-muted" target="_blank">Blog</a>
              </li>
              <li class="nav-item">
                <a href="https://www.localoo.com/license" class="nav-link pe-0 text-muted" target="_blank">Licence</a>
              </li>
            </ul>
          </div>
        </div>
