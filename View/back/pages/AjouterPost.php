...
if (isset($_POST["title"]) && isset($_POST["content"]) && isset($_FILES["image"])) {
  if (!empty($_POST["title"]) && !empty($_POST["content"]) && !empty($_FILES["image"])) {
    ...
    $Post = new Post(1, $_POST['title'], $_POST['content'], $filename, 'default_metier');
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="AfficherBonPlans.php">Forum</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajouter un Post</li>
          </ol>
        </nav>
