...
// Check if 'Reserver' and 'idL' are set in GET parameters
  ...
  if (isset($_POST["Message"]) && !empty($_POST["Message"])) {
    // Add the response
    $Reponse = new Reponse($_POST['idReclamation'], $_POST['Message']);
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-2">
      ...
      <div class="card-header pb-0 d-flex justify-content-between align-items-center">
        <center><h4 class="mb-0">Modifier Reponse</h4></center>
        <div>
        </div>
      </div>
      <div class="card-body">
        ...
        <input type="hidden" name="idReclamation" value="<?php echo $Reponse['idReclamation']; ?>" >

      <div class="mb-3">
        <label for="message" class="form-label">Message</label>
        <textarea class="form-control" id="Message" name="Message" rows="4" placeholder="Écrire votre Message"><?php echo $Reponse['Message']; ?></textarea>
        </div>
