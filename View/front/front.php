            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control destination-filter">
                            <option value="">Toutes destinations</option>
                            <?php foreach($listBonPlans as $bonplan) { ?>
                                <option value="<?php echo $bonplan['idBonplan']; ?>"><?php echo $bonplan['destination']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="reservation-form-card">
                    ...
                    <form id="reservation-form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="idBonPlan" name="idBonPlan"  >
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control date-picker" name="dateDepart" id="dateDepart" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nbPersonne" id="nbPersonne" min="1" >
                        </div>
            ...
            <div class="modal-body">
                <form method="POST" action="store_reservation.php" id="modal-reservation-form" onsubmit="return validateReservationForm();">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="modal-date-depart" name="dateDepart" required>
                        <div id="departError" class="error-message"></div>
                    </div>
                    
                    <div class="form-group">
                        <label for="dateRetour">Date de retour</label>
                        <input type="date" class="form-control" id="modal-date-retour" name="dateRetour" required>
                        <div id="retourError" class="error-message"></div>
                    </div>
                    
                    <div class="form-group">
                        <label for="nbPersonne">Nombre de personnes</label>
                        <input type="number" class="form-control" id="modal-nb-personne" name="nbPersonne" min="1" required>
