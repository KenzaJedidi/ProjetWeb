<?php
session_start();
// Replace relative paths with absolute paths using the project root
		...
		<section id="contact"  class="subscription">
			<div class="container">
				<div class="subscribe-title text-center">
					...
					<p>
						Localoo offer you to list your business with us and we very much able to promote your Business.
					</p>
				</div>
				<div class="row">
					<div class="col-sm-12">
