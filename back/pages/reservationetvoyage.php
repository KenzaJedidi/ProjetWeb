...
try {
    ...
    $stmt = config::getConnexion()->query("SELECT COUNT(*) as total FROM reservations WHERE statut = 'active'");
    $reservations_actives = $stmt->fetchColumn();
    
    $stmt = config::getConnexion()->query("SELECT COUNT(*) as total FROM reservations WHERE statut = 'en_attente'");
    $reservations_attente = $stmt->fetchColumn();
    
    $stmt = config::getConnexion()->query("SELECT COUNT(DISTINCT destination_id) as total FROM reservations");
    $destinations = $stmt->fetchColumn();
    
    // Taux de confirmation
    $stmt = config::getConnexion()->query("SELECT COUNT(*) as total FROM reservations WHERE statut = 'active'");
    $confirmees = $stmt->fetchColumn();
    $stmt = config::getConnexion()->query("SELECT COUNT(*) as total FROM reservations");
...
<body class="g-sidenav-show bg-gray-100">
      ...
      <div class="row mb-4">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card hover-effect">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0"><?= $reservations_actives ?></h4>
                </div>
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder"><?= round($reservations_actives / max($total, 1) * 100) ?>%</span> des réservations</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card hover-effect">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0"><?= $reservations_attente ?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-warning font-weight-bolder"><?= round($reservations_attente / max($total, 1) * 100) ?>%</span> des réservations</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card hover-effect">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Destinations</p>
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-info font-weight-bolder"><?= $total ?></span> réservations totales</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6">
          <div class="card hover-effect">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0"><?= $taux_confirmation ?>%</h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder"><?= $confirmees ?></span> confirmations</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              ...
              <div>
                <a href="export-reservations.php" class="btn btn-outline-dark btn-sm me-2">Exporter</a>
                <a href="addreservation.php" class="btn btn-custom btn-sm">Ajouter</a>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?= htmlspecialchars($reservation['id']) ?></p>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?= htmlspecialchars($reservation['nom']) ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?= htmlspecialchars($reservation['prenom']) ?></p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?= htmlspecialchars($reservation['destination_nom']) ?></p>
                      </td>
                      <td>
                        <p class="text-xs mb-0"><?= date('d/m/Y', strtotime($reservation['date_depart'])) ?></p>
                      </td>
                      <td class="align-middle text-center">
                        ...
                        $badgeClass = [
                            ...
                            'refusee' => 'bg-gradient-danger',
                            'annulee' => 'bg-gradient-secondary'
                        ][$reservation['statut']] ?? 'bg-gradient-secondary';
                        ?>
                      ...
                      <td class="align-middle text-center">
                        <a href="edit-reservation.php?id=<?= $reservation['id'] ?>" class="btn btn-custom btn-sm">Modifier</a>
                        <a href="delete-reservation.php?id=<?= $reservation['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette réservation ?');">Supprimer</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const alerts = document.querySelectorAll('.alert-center');
